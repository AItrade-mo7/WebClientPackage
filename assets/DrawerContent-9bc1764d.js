import{E as fe,H as be,K as ge,d as j,r as k,$ as Y,bn as A,W as z,S as X,a8 as me,au as ve,C as pe,af as we,aT as ye,bo as ze,ab as O,an as Se,aj as $e,am as Ce,aS as _,bp as L,D as s,bq as xe,ak as V,Y as Be,ae as q,a6 as n,bb as P,N as b,Q as w,a5 as B,br as ke,aR as Ee,V as K,a2 as U,bs as Re,a9 as Te,bt as Fe,bu as Me,a4 as C,bv as Oe,aQ as Pe,bw as Ie}from"./index-95e0417b.js";import{u as W}from"./use-merged-state-2a0ec557.js";import{f as N}from"./format-length-c9d165c6.js";const He=e=>{const{modalColor:t,textColor1:r,textColor2:u,boxShadow3:d,lineHeight:g,fontWeightStrong:l,dividerColor:h,closeColorHover:f,closeColorPressed:v,closeIconColor:c,closeIconColorHover:E,closeIconColorPressed:R,borderRadius:T,primaryColorHover:F}=e;return{bodyPadding:"16px 24px",headerPadding:"16px 24px",footerPadding:"16px 24px",color:t,textColor:u,titleTextColor:r,titleFontSize:"18px",titleFontWeight:l,boxShadow:d,lineHeight:g,headerBorderBottom:`1px solid ${h}`,footerBorderTop:`1px solid ${h}`,closeIconColor:c,closeIconColorHover:E,closeIconColorPressed:R,closeSize:"22px",closeIconSize:"18px",closeColorHover:f,closeColorPressed:v,closeBorderRadius:T,resizableTriggerColorHover:F}},De=fe({name:"Drawer",common:be,peers:{Scrollbar:ge},self:He}),_e=De,je=j({name:"NDrawerContent",inheritAttrs:!1,props:{blockScroll:Boolean,show:{type:Boolean,default:void 0},displayDirective:{type:String,required:!0},placement:{type:String,required:!0},contentStyle:[Object,String],nativeScrollbar:{type:Boolean,required:!0},scrollbarProps:Object,trapFocus:{type:Boolean,default:!0},autoFocus:{type:Boolean,default:!0},showMask:{type:[Boolean,String],required:!0},resizable:Boolean,onClickoutside:Function,onAfterLeave:Function,onAfterEnter:Function,onEsc:Function},setup(e){const t=k(!!e.show),r=k(null),u=Y(A);let d=0,g="",l=null;const h=k(!1),f=k(!1),v=z(()=>e.placement==="top"||e.placement==="bottom"),{mergedClsPrefixRef:c,mergedRtlRef:E}=X(e),R=me("Drawer",E,c),T=o=>{f.value=!0,d=v.value?o.clientY:o.clientX,g=document.body.style.cursor,document.body.style.cursor=v.value?"ns-resize":"ew-resize",document.body.addEventListener("mousemove",x),document.body.addEventListener("mouseleave",p),document.body.addEventListener("mouseup",y)},F=()=>{l!==null&&(window.clearTimeout(l),l=null),f.value?h.value=!0:l=window.setTimeout(()=>{h.value=!0},300)},I=()=>{l!==null&&(window.clearTimeout(l),l=null),h.value=!1},{doUpdateHeight:H,doUpdateWidth:D}=u,x=o=>{var m,M;if(f.value)if(v.value){let S=((m=r.value)===null||m===void 0?void 0:m.offsetHeight)||0;const $=d-o.clientY;S+=e.placement==="bottom"?$:-$,H(S),d=o.clientY}else{let S=((M=r.value)===null||M===void 0?void 0:M.offsetWidth)||0;const $=d-o.clientX;S+=e.placement==="right"?$:-$,D(S),d=o.clientX}},y=()=>{f.value&&(d=0,f.value=!1,document.body.style.cursor=g,document.body.removeEventListener("mousemove",x),document.body.removeEventListener("mouseup",y),document.body.removeEventListener("mouseleave",p))},p=y;ve(()=>{e.show&&(t.value=!0)}),pe(()=>e.show,o=>{o||y()}),we(()=>{y()});const i=z(()=>{const{show:o}=e,m=[[L,o]];return e.showMask||m.push([ye,e.onClickoutside,void 0,{capture:!0}]),m});function a(){var o;t.value=!1,(o=e.onAfterLeave)===null||o===void 0||o.call(e)}return ze(z(()=>e.blockScroll&&t.value)),O(Se,r),O($e,null),O(Ce,null),{bodyRef:r,rtlEnabled:R,mergedClsPrefix:u.mergedClsPrefixRef,isMounted:u.isMountedRef,mergedTheme:u.mergedThemeRef,displayed:t,transitionName:z(()=>({right:"slide-in-from-right-transition",left:"slide-in-from-left-transition",top:"slide-in-from-top-transition",bottom:"slide-in-from-bottom-transition"})[e.placement]),handleAfterLeave:a,bodyDirectives:i,handleMousedownResizeTrigger:T,handleMouseenterResizeTrigger:F,handleMouseleaveResizeTrigger:I,isDragging:f,isHoverOnResizeTrigger:h}},render(){const{$slots:e,mergedClsPrefix:t}=this;return this.displayDirective==="show"||this.displayed||this.show?_(s("div",{role:"none"},s(xe,{disabled:!this.showMask||!this.trapFocus,active:this.show,autoFocus:this.autoFocus,onEsc:this.onEsc},{default:()=>s(V,{name:this.transitionName,appear:this.isMounted,onAfterEnter:this.onAfterEnter,onAfterLeave:this.handleAfterLeave},{default:()=>_(s("div",Be(this.$attrs,{role:"dialog",ref:"bodyRef","aria-modal":"true",class:[`${t}-drawer`,this.rtlEnabled&&`${t}-drawer--rtl`,`${t}-drawer--${this.placement}-placement`,this.isDragging&&`${t}-drawer--unselectable`,this.nativeScrollbar&&`${t}-drawer--native-scrollbar`]}),[this.resizable?s("div",{class:[`${t}-drawer__resize-trigger`,(this.isDragging||this.isHoverOnResizeTrigger)&&`${t}-drawer__resize-trigger--hover`],onMouseenter:this.handleMouseenterResizeTrigger,onMouseleave:this.handleMouseleaveResizeTrigger,onMousedown:this.handleMousedownResizeTrigger}):null,this.nativeScrollbar?s("div",{class:`${t}-drawer-content-wrapper`,style:this.contentStyle,role:"none"},e):s(q,Object.assign({},this.scrollbarProps,{contentStyle:this.contentStyle,contentClass:`${t}-drawer-content-wrapper`,theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar}),e)]),this.bodyDirectives)})})),[[L,this.displayDirective==="if"||this.displayed||this.show]]):null}}),{cubicBezierEaseIn:Ae,cubicBezierEaseOut:Le}=P;function Ue({duration:e="0.3s",leaveDuration:t="0.2s",name:r="slide-in-from-right"}={}){return[n(`&.${r}-transition-leave-active`,{transition:`transform ${t} ${Ae}`}),n(`&.${r}-transition-enter-active`,{transition:`transform ${e} ${Le}`}),n(`&.${r}-transition-enter-to`,{transform:"translateX(0)"}),n(`&.${r}-transition-enter-from`,{transform:"translateX(100%)"}),n(`&.${r}-transition-leave-from`,{transform:"translateX(0)"}),n(`&.${r}-transition-leave-to`,{transform:"translateX(100%)"})]}const{cubicBezierEaseIn:We,cubicBezierEaseOut:Ne}=P;function Ye({duration:e="0.3s",leaveDuration:t="0.2s",name:r="slide-in-from-left"}={}){return[n(`&.${r}-transition-leave-active`,{transition:`transform ${t} ${We}`}),n(`&.${r}-transition-enter-active`,{transition:`transform ${e} ${Ne}`}),n(`&.${r}-transition-enter-to`,{transform:"translateX(0)"}),n(`&.${r}-transition-enter-from`,{transform:"translateX(-100%)"}),n(`&.${r}-transition-leave-from`,{transform:"translateX(0)"}),n(`&.${r}-transition-leave-to`,{transform:"translateX(-100%)"})]}const{cubicBezierEaseIn:Xe,cubicBezierEaseOut:Ve}=P;function qe({duration:e="0.3s",leaveDuration:t="0.2s",name:r="slide-in-from-top"}={}){return[n(`&.${r}-transition-leave-active`,{transition:`transform ${t} ${Xe}`}),n(`&.${r}-transition-enter-active`,{transition:`transform ${e} ${Ve}`}),n(`&.${r}-transition-enter-to`,{transform:"translateY(0)"}),n(`&.${r}-transition-enter-from`,{transform:"translateY(-100%)"}),n(`&.${r}-transition-leave-from`,{transform:"translateY(0)"}),n(`&.${r}-transition-leave-to`,{transform:"translateY(-100%)"})]}const{cubicBezierEaseIn:Ke,cubicBezierEaseOut:Qe}=P;function Ge({duration:e="0.3s",leaveDuration:t="0.2s",name:r="slide-in-from-bottom"}={}){return[n(`&.${r}-transition-leave-active`,{transition:`transform ${t} ${Ke}`}),n(`&.${r}-transition-enter-active`,{transition:`transform ${e} ${Qe}`}),n(`&.${r}-transition-enter-to`,{transform:"translateY(0)"}),n(`&.${r}-transition-enter-from`,{transform:"translateY(100%)"}),n(`&.${r}-transition-leave-from`,{transform:"translateY(0)"}),n(`&.${r}-transition-leave-to`,{transform:"translateY(100%)"})]}const Je=n([b("drawer",`
